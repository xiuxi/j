...
#https://github.com/cjavapy/free-google-translate
...
class GoogleTrans(object):
    def __init__(self):
        ...
        with open('D:\\gitHub\\java_ubuntu_windows\\src\\main\\java\\j\\token.js', 'r', encoding='utf-8') as f:  
...
if __name__ == '__main__':
    ...
    trans = GoogleTrans()
    targetText = trans.query(text, lang_to='zh-CN')  
    print(targetText)
    sys.exit(0)
    text = """Hello world This library is no longer maintananced. Bugs are not be fixed (even if they are trivial or essential).
